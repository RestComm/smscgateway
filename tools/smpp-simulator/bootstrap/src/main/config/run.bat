...
if exist "%SIMULATOR_HOME%\native" set PATH=%SIMULATOR_HOME%\native;%PATH%
...
set RUNJAR=%SIMULATOR_HOME%\bin\run.jar
...
if "%SIMULATOR_CLASSPATH%" == "" set RUN_CLASSPATH=%RUNJAR%
if "%RUN_CLASSPATH%" == "" set RUN_CLASSPATH=%SIMULATOR_CLASSPATH%;%RUNJAR%

set SIMULATOR_CLASSPATH=%RUN_CLASSPATH%
...
set SIMULATOR_ENDORSED_DIRS=%SIMULATOR_HOME%\lib


echo ===============================================================================
echo.
echo   SIMULATOR Bootstrap Environment
echo.
...
echo   
echo   SIMULATOR_ENDORSED_DIRS: %SIMULATOR_ENDORSED_DIRS%
echo.
echo ===============================================================================
echo.

:RESTART
"%JAVA%" %JAVA_OPTS% -Djava.ext.dirs="%SIMULATOR_ENDORSED_DIRS%" -Dmbrola.base="%SIMULATOR_HOME%/mbrola" -classpath "%SIMULATOR_CLASSPATH%" org.mobicents.smsc.tools.smppsimulator.bootstrap.Main %*
