...
= SMSC Gateway Server Settings (Wildfly 10)
...
DESCRIPTION
        ...
        "mobicents-smscgateway-version/wildfly-10.1.0.Final/standalone/configuration/standalone.xml".
----
...
Correlation table is stored into "wildfly-10.1.0.Final/standalone/data" and has name "SmscManagement_cc_mccmnc.xml". The content of this should follow the following template: 
