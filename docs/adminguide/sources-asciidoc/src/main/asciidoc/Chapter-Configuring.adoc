...
| mprocErrorCountersEnabled | - / <null \|true \| false> | Overrides global setting for counters to be calculated per every MProc rule. If set to true, counter will be calculated for this partcular mproc rule. If not set - global mprocErrorCountersEnabled setting applies. | null
|===
