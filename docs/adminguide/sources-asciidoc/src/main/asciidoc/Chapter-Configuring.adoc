...
| newmtgt | Arrival trigger / <mtgt value> | global title of the message will be changed to <mtgt value>. This means that MT message will be rerouted to GT different from what is specified by SMSC for current networkId. | "-1". This means that GT of the message will not be changed.
| newmttt | Arrival trigger / <mttt value> | translation type of the message will be changed to <mttt value>. This means that desired TT of MT message will be used rather than what SMSC sets by default for current networkId. | -1. This means that TT of the message will not be changed.
