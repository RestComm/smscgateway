...
SYNOPSIS
	...
	<new source numbering plan indicator> newsourceaddr <new source address value> newmtgt 
	<new gt for mt message> newmttt <new tt for mt message> hrbypass
...
PARAMETERS
	...
	newmtgt - an optional parameter.
	newmttt - an optional parameter.
...
SYNOPSIS
	...
	newmtgt <new gt for mt message> newmttt <new tt for mt message> hrbypass
	<false | true> dropaftersri <false | true> newnetworkidaftersri <networkId value>
	dropaftertempfail <false | true> newnetworkidaftertempfail <networkId value>
	droponarrival <false | true> rejectonarrival <NONE | DEFAULT | UNEXPECTED_DATA_VALUE
	| SYSTEM_FAILURE | THROTTLING | FACILITY_NOT_SUPPORTED> remove_tlv <tlv tag key>
