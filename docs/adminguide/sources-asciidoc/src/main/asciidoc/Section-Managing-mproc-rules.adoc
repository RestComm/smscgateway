...
SYNOPSIS
	...
	indicator> destdigmask <regular expression - destination number digits mask> sourcetonmask 
	...
	adddestdigprefix <prefix value> newsourceton <new source type of number> newsourcenpi 
