...
The User Guide (available along with this Installation Guide) in the [path]_{this-folder}-ss7-<version>/ss7/docs_ folder will assist you in configuring and managing the Stack.
