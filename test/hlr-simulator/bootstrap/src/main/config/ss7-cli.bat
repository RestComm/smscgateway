@echo off
rem -------------------------------------------------------------------------
rem RestComm SS7 CLI Bootstrap Script for Win32
rem -------------------------------------------------------------------------
...
:RESTART
"%JAVA%" %JAVA_OPTS% -Djava.ext.dirs="%SHELL_ENDORSED_DIRS%" -classpath "%SHELL_CLASSPATH%" org.restcomm.ss7.management.console.Shell %*
