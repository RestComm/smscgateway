...
/**
 * TestVersion class reads the version.properties packaged with media-server.jar
 * for run time display of Media Server TestVersion
 * 
 * @author amit.bhayani
 * 
 */
public final class TestVersion {
	 ...
	 * The single instance.
	 */
	public final static TestVersion instance = new TestVersion();
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("RestComm SMSC Test Server: ");
		boolean first = true;
